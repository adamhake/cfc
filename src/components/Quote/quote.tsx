...
export default function Quote() {
  return (
    <div className="px-4 lg:px-0">
      <div className="relative mx-auto w-full max-w-6xl overflow-hidden rounded-3xl bg-green-800 px-8 py-16 lg:py-24">
        <Image
        ...
        <div className="relative z-10 mx-auto max-w-3xl space-y-8 text-green-50">
          ...
          <p className="max-w-3xl font-body text-xl font-normal text-green-50 lg:text-3xl">
