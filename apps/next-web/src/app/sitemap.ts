...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    { url: SITE_CONFIG.url, lastModified: toDate(pages.home), changeFrequency: "weekly", priority: 1 },
    { url: `${SITE_CONFIG.url}/about`, lastModified: toDate(pages.about), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_CONFIG.url}/events`, lastModified: toDate(pages.events), changeFrequency: "weekly", priority: 0.9 },
    { url: `${SITE_CONFIG.url}/projects`, lastModified: toDate(pages.projects), changeFrequency: "weekly", priority: 0.9 },
    { url: `${SITE_CONFIG.url}/amenities`, lastModified: toDate(pages.amenities), changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_CONFIG.url}/history`, lastModified: toDate(pages.history), changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE_CONFIG.url}/get-involved`, lastModified: toDate(pages.getInvolved), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_CONFIG.url}/donate`, lastModified: toDate(pages.donate), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_CONFIG.url}/media`, lastModified: toDate(pages.media), changeFrequency: "weekly", priority: 0.6 },
    { url: `${SITE_CONFIG.url}/privacy-policy`, lastModified: new Date("2025-01-01"), changeFrequency: "yearly", priority: 0.2 },
  ];
